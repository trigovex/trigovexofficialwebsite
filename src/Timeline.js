                ...
                <div className="col-md-5">
                    <div className="timeline">
                        ...
                        <div className="event">
                            ...
                            <p data-aos="fade-right" data-aos-delay="0"><img src={tick} alt="Check" /> Detailed documentation and project scope definition keep all parties aligned.</p>
                        </div>
                        ...
                        <div className="event">
                            ...
                            <p data-aos="fade-right" data-aos-delay="0"><img src={tick} alt="Check" /> Agile development with regular client feedback refines the solution along the way.</p>
                        </div>
                        ...
                        <div className="event">
                            ...
                            <p data-aos="fade-right" data-aos-delay="0"><img src={tick} alt="Check" /> Smooth deployment and attentive post-launch support ensure continued success.</p>
                        </div>
                    </div>
                </div>
