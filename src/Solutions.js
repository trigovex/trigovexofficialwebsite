    ...
    <div className="solutions-container my-5">
      ...
      <div className="row mb-4 align-items-center">
        ...
        <div className="col-md-2 text-center">
          ...
          <img src={horizontal} alt="Connecting Icon Desktop" className="solution-image d-none d-md-block" />
          {/* SVG for Mobile View */}
          <img src={vertical} alt="Connecting Icon Mobile" className="solution-image-mobile d-md-none vertical-image" />
        </div>
      ...
      <div className="row align-items-center">
        <div className="col-md-5">
          <div className="challenge-box" data-aos="fade-right" data-aos-duration="1500">
        ...
        <div className="col-md-2 text-center">
          {/* SVG for Desktop View */}
          <img src={horizontal} alt="Engagement Icon Desktop" className="solution-image d-none d-md-block" />
          {/* SVG for Mobile View */}
          <img src={vertical} alt="Engagement Icon Mobile" className="solution-image-mobile d-md-none vertical-image" />
        </div>

        <div className="col-md-5">
          <div className="solution-box" data-aos="fade-left" data-aos-duration="1500">
            <h4 className="solution-title mobile-centered">Solution</h4>
